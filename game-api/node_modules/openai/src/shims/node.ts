// @ts-ignore
import * as types from 'openai/src/_shims/node-types';
import { setShims } from 'openai/src/_shims/registry';
import { getRuntime } from 'openai/src/_shims/node-runtime';
setShims(getRuntime());

declare module 'openai/src/_shims/manual-types' {
