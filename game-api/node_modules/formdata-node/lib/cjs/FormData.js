...
const File_1 = require("formdata-node/lib/cjs/File");
const isFile_1 = require("formdata-node/lib/cjs/isFile");
const isBlob_1 = require("formdata-node/lib/cjs/isBlob");
const isFunction_1 = require("formdata-node/lib/cjs/isFunction");
const deprecateConstructorEntries_1 = require("formdata-node/lib/cjs/deprecateConstructorEntries");
class FormData {
    constructor(entries) {
